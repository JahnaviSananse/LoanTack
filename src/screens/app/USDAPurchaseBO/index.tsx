...
const USDAPurchaseBO = (props: IUSDAProps) => {
  ...
  React.useEffect(() => {
    ...
    if (props.usdaError && !props.loading) {
      let obj = {
        message: props.usdaError !== undefined ? props.usdaError : '',
        type: 'failure',
      };
      setTimeout(() => {
  ...
  }, [props.defaultData, props.usdaError]);
...
const mapStateToProps = (state: IReduxState) => ({
  ...
  usdaError: state.calculation.usdaError,

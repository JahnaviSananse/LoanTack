...
interface IJumboInterface {
  defaultData: any;
  getDefault: Function;
  jumboCalculation: Function;
  loading: boolean;
...
const JumboPurchaseBO = (props: IJumboInterface) => {
  ...
  React.useEffect(() => {
    ...
    if (props.jumboError && !props.loading) {
      let obj = {
        message: props.jumboError !== undefined ? props.jumboError : '',
        type: 'failure',
      };
      setTimeout(() => {
  ...
  }, [props.defaultData, props.jumboError]);
  ...
  const CalculateJumbo = () => {
    ...
    //console.log(request);
    props.jumboCalculation(request);
  };
...
const mapStateToProps = (state: IReduxState) => ({
  ...
  jumboError: state.calculation.jumboError,

...
import {
  clearDefaultData,
  convetionalRefinanceCalculation,
  getCounty,
  getDefault,
...
interface IConvetionalProps {
  defaultData: any;
  getDefault: Function;
  convetionalRefinanceCalculation: Function;
  loading: boolean;
  OpenValidationAlert: Function;
  closeModal: Function;
  conventionalRefinanceError: string;
...
const ConventionalRefinanceBO = (props: IConvetionalProps) => {
  ...
  React.useEffect(() => {
    ...
    if (props.conventionalRefinanceError && !props.loading) {
      let obj = {
        message:
          props.conventionalRefinanceError !== undefined
            ? props.conventionalRefinanceError
            : '',
        type: 'failure',
      };
      setTimeout(() => {
  ...
  }, [props.defaultData, props.conventionalRefinanceError]);
  ...
  const validateForm = () => {
    ...
    if (!isValidate) {
      ...
      CalculateConvetional();
    }
  };
  const CalculateConvetional = () => {
    let request: any = {};
    ...
    props.convetionalRefinanceCalculation(request);
  };
...
const mapStateToProps = (state: IReduxState) => ({
  ...
  conventionalRefinanceError: state.calculation.conventionalRefinanceError,

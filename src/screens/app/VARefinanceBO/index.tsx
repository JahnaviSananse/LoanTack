...
interface IVAProps {
  defaultData: any;
  getDefault: Function;
  vaRefinanceCalculation: Function;
  loading: boolean;
  OpenValidationAlert: Function;
  closeModal: Function;
  vaRefinanceError: string;
...
const VARefinanceBO = (props: IVAProps) => {
  ...
  React.useEffect(() => {
    ...
    if (props.vaRefinanceError && !props.loading) {
      let obj = {
        message:
          props.vaRefinanceError !== undefined ? props.vaRefinanceError : '',
        type: 'failure',
      };
      setTimeout(() => {
  ...
  }, [props.defaultData, props.vaRefinanceError]);
  ...
  const CalculateVA = () => {
    ...
    props.vaRefinanceCalculation(request);
  };
                      ...
                      onEndEditing={() => {
                        if (
                          ...
                          setTimeout(() => {
                            ...
                            currentData[0].value = final > 0 ? per : 0;
                            setData(currentData);
                          }, 100);
                        }
                      }}
...
const mapStateToProps = (state: IReduxState) => ({
  ...
  vaRefinanceError: state.calculation.vaRefinanceError,

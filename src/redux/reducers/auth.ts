...
export default (
  ...
  switch (action.type) {
    //info message
    case TYPE.GET_INFO_MESSAGE_REQUEST: {
      return {
        ...state,
        loading: true,
        infoMessages: {},
    ...
    case TYPE.GET_INFO_MESSAGE_SUCCESS: {
      return {
        ...state,
        loading: false,
        infoMessages: action.payload.data.help_messages,
        infoMessageError: '',
      };
    }
    case TYPE.GET_INFO_MESSAGE_FAILURE: {
      return {
        ...state,
        loading: false,
        infoMessageError: action.payload,
        infoMessages: {},
      };
    }
    //signup
    ...
    case TYPE.LOGIN_SUCCESS_EMAIL: {
      let accesstoken = '';
      let refreshtoken = '';
      if (action.payload.data.token) {
        accesstoken = action.payload.data.token.token.access_token;
        refreshtoken = action.payload.data.token.token.refresh_token;
      }
      console.log('RED Data', action.payload.data);
      return {
        ...state,
        loading: false,
        email: action.payload.data.email,
        access_token: accesstoken,
        refresh_token: refreshtoken,
        userData: action.payload.data.token.user,
      };
    }
